<div class="">
    <div class="h-full p-6 bg-white rounded-lg">
        <div class="mx-auto w-full max-w-lg pb-10 border-b-3 border-warna-100">
            ...
            <p class="text-3xl sm:text-4xl font-semibold text-center mx-auto px-6 py-3 rounded-lg bg-warna-700/30 text-warna-700">Rp {{ number_format($total_pendapatan, 0, ',', '.') }}</p>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    @foreach($transaksi_hari_ini as $item)
                        <tr class="border-b border-warna-200 odd:bg-white even:bg-warna-50">
